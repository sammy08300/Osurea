...
const DOM = {
     ...
     */
    throttle(func, wait) {
        return PerformanceUtils.throttle(func, wait);
    },
...
Numbers.calculateRatioMemoized = PerformanceUtils.memoize(Numbers.calculateRatio, 
    (width, height) => `${width}:${height}`, 500);

// Export Performance namespace directly
